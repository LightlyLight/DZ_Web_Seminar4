...
$experience = [
    [
        ...
        'date' => 'Январь 2023 - ',
        'end_date' => 'Current',
        'description' => 'Работаю главным мурчалой',
    ],
    [
        'name' => 'Ассистент',
        'date' => 'Июль 2022 - Декабрь 2023',
        'end_date' => 'None',
        'description' => 'Изучал повадки мышей',
    ],
    [
        'name' => 'Стажер',
        'date' => 'Январь 2022 - Июнь 2022',
        'end_date' => 'None',
        'description' => 'Вел учет мышей',
    ],
];
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
              ...
              <?php for ($i = 0; $i < count($experience); $i++): ?>
                <div class="w3-container">      
                    ...
                    class="w3-tag w3-teal w3-round"><?php if ($experience[$i]["end_date"] == "Current") echo " Настоящее время" ?></span></h6>
